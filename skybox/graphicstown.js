...
window.onload = function() {
    ...
    var sliders = makeSliders([["TimeOfDay",0,24,12], ["Hermit_rollerCoaster",0,100,0], ["bezier",0,100,0]]);
...
var counter2 = 0;
    ...
    function draw() {
        ...
        var curving = Number(sliders.Hermit_rollerCoaster.value);
        var bezier = Number(sliders.bezier.value);
        var sunAngle = Math.PI * (tod-6)/12;
        var sunDirection = [5*Math.cos(sunAngle),6,5*Math.sin(sunAngle)];
