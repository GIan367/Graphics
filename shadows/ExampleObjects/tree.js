...
grobjects.push(new Tree("tree 1",[2.5,0.3, -4.0],0.5, [0.0,0.0,0.4]) );
grobjects.push(new Tree("tree 1",[-2.5,0.3, 4.0],0.7, [0.0,0.0,0.4]) );

grobjects.push(new Tree("tree 1",[-4.0,.7, -4.0],1.6, [0.0,0.0,0.4]) );
